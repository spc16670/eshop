	    ...
	    <!-- List available items -->
	      ...
	      <div>
		    ...
		    <h5>{[ category.data.description ]}</h5>
	          ...
	          <div class="col-sm-3">
		    <div>
		      <button type="button" class="btn btn-warning" ng-click="handleCategory(category)">Modify</button>
		      <button type="button" class="btn btn-danger" ng-click="handleCategory(category)">Remove</button>
                    </div>
	          </div>
	        </div>
